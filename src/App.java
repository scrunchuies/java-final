...
public class App {
  ...
  public int budget(Scanner scan) {
    ...
    if (twoMil.toUpperCase().equals("Y")) {
      ...
      if (oneMil.toUpperCase().equals("Y")) {
        ...
        System.out
            .println("What?? Um... that\'s okay. We can work with this. Do you have 500 thousand to spend? " + ender);
  ...
  public int timeSpent(Scanner scan) {
    ...
    if (!(month.toUpperCase().equals("Y"))) {
      ...
      if (year.toUpperCase().equals("Y")) {
        ...
        return (int) Math.random() * 1095;

      } else {

        return (int) Math.random() * 182;
      }
    }
  }
